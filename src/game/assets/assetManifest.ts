...
export const ITEM_TEXTURE_KEYS: Record<MineItemType, ItemTextureKey> = {
...
export const ASSET_MANIFEST: readonly RuntimeAssetDescriptor[] = [
  ...
  { key: AssetKeys.miner.atlas, kind: "atlas", fallbackKey: AssetKeys.miner.placeholder, width: 256, height: 256, transparent: true, placeholder: true, frames: 53, origin: [0.5, 0.92], scale: 1 },
  ...
  ...Object.values(AssetKeys.particles).map((key) => ({
    key,
